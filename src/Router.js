...
const Pdfform = lazy(() => import("./views/apps/freshlist/accounts/Pdfform"));
const Advocateform = lazy(() => import("./views/apps/freshlist/accounts/Advocateform"));
const ViewAdvocate = lazy(() => import("./views/apps/freshlist/accounts/ViewAdvocate"));
